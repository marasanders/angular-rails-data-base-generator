...
butternutSquashSoup = Recipe.create!(title:"Butternut Squash Soup",  servings: 6, calories: 130, rating: 2, category: soup, instructions: "Cut butternut squash in half and bake at 375 degrees face down on baking sheet for 1 hour. Dice onion and fry on medium heat  in 4 quart pot until transparent, add crushed galic and continue frying for 2 minutes. Scoop flesh add to pot. Alternately cube and peel raw butternut squash and place in pot.  Add water, salt, pepper and consume mix, bring to a boil. Lower flame to simmer for one hour. Remove from heat and blend with hand blender. Can serve with cinnamon and/or cream garnish.")

chocolateCakeIngredient1 = Ingredient.create!(component: "Flour", amount:"4", measurement: "C", recipe: chocolateCake)
chocolateCakeIngredient2 = Ingredient.create!(component: "Cocoa", amount:"3/4", measurement: "C", recipe: chocolateCake)
chocolateCakeIngredient3 = Ingredient.create!(component: "Sugar", amount:"2", measurement: "C", recipe: chocolateCake)
chocolateCakeIngredient4 = Ingredient.create!(component: "Oil", amount:"1", measurement: "C", recipe: chocolateCake)
chocolateCakeIngredient5 = Ingredient.create!(component: "Water", amount:"1", measurement: "C", recipe: chocolateCake)
chocolateCakeIngredient6 = Ingredient.create!(component: "Eggs", amount:"4", recipe: chocolateCake)
chocolateCakeIngredient7 = Ingredient.create!(component: "Baking Powder", amount:"1 3/4", measurement: "tsp", recipe: chocolateCake)
...
butternutSquashSoupIngredient8 = Ingredient.create!(component: "Onion", amount:"Medium", measurement: "tsp",recipe: broiledChicken)
butternutSquashSoupIngredient2 = Ingredient.create!(component: "Oil", amount:"2", measurement: "Tbs",recipe: butternutSquashSoup)
butternutSquashSoupIngredient8 = Ingredient.create!(component: "Garlic Crushed", amount:"1", measurement: "tsp",recipe: butternutSquashSoup)
